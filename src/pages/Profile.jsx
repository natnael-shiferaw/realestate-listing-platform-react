    ...
    <>
      <section className="flex max-w-6xl mx-auto flex-col items-center justify-center">
        ...
        <div className="w-full md:w-[50%] px-3 mt-6">
          ...
          <button type="submit" className="w-full bg-blue-600 text-white uppercase px-7 py-2 font-medium text-sm rounded shadow-sm hover:bg-blue-700 transition ease-in-out duration-150 hover:shadow-lg active:bg-blue-800">
